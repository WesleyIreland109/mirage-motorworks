...
function VehicleForm({ purpose, done }: { purpose: VehiclePurpose; done: () => void }) {
  ...
  const [form, setForm] = useState({ year: new Date().getFullYear(), make: "", model: "", trim: "", mileage: 0, ownerName: "", acquisitionPrice: "", targetPrice: "", notes: "" });
  ...
  const submit = () => mutation.mutate({
    year: form.year, make: form.make, model: form.model, trim: form.trim, mileage: form.mileage,
