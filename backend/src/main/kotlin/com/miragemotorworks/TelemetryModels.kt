...
@Serializable data class SessionImport(val vehicleId: String, val externalSessionId: String, val label: String, val startedAt: String, val durationMs: Long, val samples: Long, val obdRequests: Long, val obdErrors: Long, val source: String, val metrics: List<MetricSummary>)
@Serializable data class TelemetrySession(val id: String, val vehicleId: String, val externalSessionId: String, val label: String, val startedAt: String, val durationMs: Long, val samples: Long, val obdRequests: Long, val obdErrors: Long, val source: String, val metrics: List<MetricSummary>, val importedAt: String)
